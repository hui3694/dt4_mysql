...
namespace DTcms.DAL
{
    ...
    public partial class manager_role
    {
        ...
        public string GetTitle(int id)
        {
            ...
            string title = Convert.ToString(MysqlHelper.GetSingle(strSql.ToString()));
        ...
        public int Add(Model.manager_role model)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("@role_name", MySqlDbType.VarString,100),
					new MySqlParameter("@role_type", MySqlDbType.Int32,1),
            ...
            MysqlHelper.ExecuteSqlTranWithIndentity(sqllist);
        ...
        public bool Update(Model.manager_role model)
        {
            ...
            int rowsAffected = MysqlHelper.ExecuteSqlTran(sqllist);
            if (rowsAffected > 0)
            {
                return true;
            }
        ...
        public Model.manager_role GetModel(int id)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                MySqlParameter[] parameters2 = {
					new MySqlParameter("@role_id", MySqlDbType.Int32,4)};
                parameters2[0].Value = id;
                DataSet ds2 = MysqlHelper.Query(strSql2.ToString(), parameters2);
