...
namespace DTcms.DAL
{
    ...
    /// 数据访问类:后台导航菜单
    /// </summary>
    public partial class MySqlNavigation
    {
        private string databaseprefix; //数据库表名前缀
        public MySqlNavigation(string _databaseprefix)
        {
        ...
        /// 返回ID
        /// </summary>
        public int GetId(MySqlConnection conn, MySqlTransaction trans, string name)
        {
            MySqlParameter[] parameters = {
                    new MySqlParameter("@name", MySqlDbType.VarString,50)};
            parameters[0].Value = name;
            object obj = MysqlHelper.GetSingle(conn, trans, "select id from " + databaseprefix + "navigation where name=@name", parameters);
        ...
        public int Add(Model.navigation model)
        {
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@nav_type", MySqlDbType.VarString,50),
                    new MySqlParameter("@name", MySqlDbType.VarString,50),
                    new MySqlParameter("@title", MySqlDbType.VarString,100),
                    new MySqlParameter("@sub_title", MySqlDbType.VarString,100),
                    new MySqlParameter("@icon_url", MySqlDbType.VarString,255),
                    new MySqlParameter("@link_url", MySqlDbType.VarString,255),
                    new MySqlParameter("@sort_id", MySqlDbType.Int32,4),
                    new MySqlParameter("@is_lock", MySqlDbType.Int32,1),
                    new MySqlParameter("@remark", MySqlDbType.VarString,500),
                    new MySqlParameter("@action_type", MySqlDbType.VarString,500),
        ...
        public Model.navigation GetModel(string nav_name)
        {
            ...
            MySqlParameter[] parameters = {
                    new MySqlParameter("@nav_name", MySqlDbType.VarString,50)};
        ...
        public int GetNavId(string nav_name)
        {
            ...
            MySqlParameter[] parameters = {
                    new MySqlParameter("@nav_name", MySqlDbType.VarString,50)};
            parameters[0].Value = nav_name;
            string str = Convert.ToString(MysqlHelper.GetSingle(strSql.ToString(), parameters));
        ...
        public bool Update(MySqlConnection conn, MySqlTransaction trans, string old_name, string new_name)
        {
            ...
            MySqlParameter[] parameters = {
                                new MySqlParameter("@new_name", MySqlDbType.VarString,50),
                                new MySqlParameter("@old_name", MySqlDbType.VarString,50)};
            parameters[0].Value = new_name;
            parameters[1].Value = old_name;
            int rows = MysqlHelper.ExecuteSql(conn, trans, strSql.ToString(), parameters);
            if (rows > 0)
            {
                return true;
            }
        ...
        public int Add(string parent_name, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type)
        {
            ...
            MySqlParameter[] parameters1 = {
                    new MySqlParameter("@parent_name", MySqlDbType.VarString,50)};
            parameters1[0].Value = parent_name;
            object obj1 = MysqlHelper.GetSingle(strSql1.ToString(), parameters1);
            if (obj1 == null)
            {
                return 0;
            }
            ...
            object obj2 = MysqlHelper.GetSingle(strSql.ToString(), parameters);
        ...
        /// 快捷添加系统默认导航，带事务
        /// </summary>
        public int Add(MySqlConnection conn, MySqlTransaction trans, string parent_name, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type, int is_lock)
        {
            //先根据名称查询该父ID
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from " + databaseprefix + "navigation");
        ...
        /// 快捷添加系统默认导航，带事务
        /// </summary>
        public int Add(MySqlConnection conn, MySqlTransaction trans, int parent_id, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type, int is_lock)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into " + databaseprefix + "navigation(");
        ...
        public Model.navigation GetModel(MySqlConnection conn, MySqlTransaction trans, string nav_name)
        {
            ...
            Model.navigation model = new Model.navigation();
            DataSet ds = MysqlHelper.Query(conn, trans, strSql.ToString(), parameters);
            if (ds.Tables[0].Rows.Count > 0)
            {
                return DataRowToModel(ds.Tables[0].Rows[0]);
            }
        ...
        {
            MysqlHelper.ExecuteSql("update [" + databaseprefix + "navigation] set icon_url = replace(icon_url,'/" + oldName + "/','/" + newName + "/')");
        }
        #endregion
